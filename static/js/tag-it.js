...
(function($) {
    ...
    $.widget('ui.tagit', {
        ...
        _create: function() {
            ...
            this._tagInput
                .keydown(function(event) {
                	...
                	var lastChar = $.trim(that._tagInput.val()).charAt($.trim(that._tagInput.val()).length - 1);
                	
                	if (!lastChar.match(/([a-zA-Z0-9\-\_]|[０-９ぁ-んァ-ン＿ー]|[ｧ-ﾝﾞﾟ]|[\u3400-\u4DBF\u4E00-\u9FFF\uD840-\uD87F\uDC00-\uDFFF\uF900-\uFAFF])/)) {
                		that._tagInput.val($.trim(that._tagInput.val()).substr(0, $.trim(that._tagInput.val()).length - 1));
                	}
                	
                	if (lastChar == '-' && that._tagInput.val().split("-").length > 2) {
                		that._tagInput.val($.trim(that._tagInput.val()).substr(0, $.trim(that._tagInput.val()).length - 1));
                	}
                }).blur(function(e){
        ...
        createTag: function(value, additionalClass) {
            ...
            if (this._tagInput.val().length <= 20) {
