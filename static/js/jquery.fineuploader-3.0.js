...
qq.FineUploaderBasic = function(o){
    ...
    this._options = {
        ...
        callbacks: {
            ...
            onAllComplete: function(completed_files){}, //add
...
qq.FineUploaderBasic.prototype = {
    ...
    _createUploadHandler: function(){
        ...
        var handler = new qq[handlerClass]({
            ...
            onAllComplete: function(completed_files){                         //add
                self._options.callbacks.onAllComplete(completed_files);       //add
            },                                                                //add
            onCancel: function(id, fileName){
    ...
    _onAllComplete: function(completed_files){                        //add
        this._options.onAllComplete(this._completed_files);           //add
    },                                                                //add
...
qq.extend(qq.UploadHandlerXhr.prototype, {
    ...
    _onComplete: function(id, xhr){
        ...
        if (xhr.status !== 200 || !response.success || xhr.status !==201){            //repair
            if (this._options.onAutoRetry(id, name, response, xhr)) {
                return;
            }
        }
        this._completed_files.push({file: this._files[id], response: response}); //add
